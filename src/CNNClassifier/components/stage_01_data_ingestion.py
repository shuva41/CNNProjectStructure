# This is where we are passing the configuration in config.yaml file to the
# DataIngestion class in stage_01_data_ingestion.py file. The type of the
# configuration is DataIngestionConfig dataclass from
# src\CNNClassifier\entity\entity.py file.
# In DataIngestion class all functions for data ingestion are defined. These
# functions will be called in data_ingestion_pipeline.py file.
